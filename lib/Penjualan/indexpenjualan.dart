...
import 'package:ukk_2025/penjualan/updatepenjualan.dart';  // Pastikan file ini ada
...
class _PenjualanTabState extends State<PenjualanTab> {
  ...
  Future<void> deleteBarang(int id) async {
    try {
      await Supabase.instance.client.from('penjualan').delete().eq('penjualanid', id);  // Pastikan nama kolom benar
      fetchPenjualan();
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            ...
                                            actions: [
                                              ...
                                              TextButton(
                                                onPressed: () {
                                                  deleteBarang(jual['penjualanid']);  // Ganti nama kolom jika perlu
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () { 
          Navigator.push(context, MaterialPageRoute(builder: (context) => AddTransaksi()));  // Pastikan AddTransaksi ada
        },
